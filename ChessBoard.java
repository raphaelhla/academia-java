...
public class ChessBoard {
	...
	public static void jogar(Scanner sc) {
		...
		do {
			System.out.print("Jogador " + jogador + ", digite a linha da posição do peão que deseja mover (0-7): ");
			linhaOrigem = sc.nextInt();
			System.out.print("Jogador " + jogador + ", digite a coluna da posição do peão que deseja mover (0-7): ");
			colunaOrigem = sc.nextInt();
			System.out.print("Jogador " + jogador + ", digite a linha de destino (0-7): ");
			linhaDestino = sc.nextInt();
			System.out.print("Jogador " + jogador + ", digite a coluna de destino (0-7): ");
